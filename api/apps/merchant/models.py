...
class Merchant(models.Model):
    ...
    api_access_ips = models.CharField(blank=True, null=True) #comma separated list of IP addresses allowed to access the API
    ...
    today_tranx_count = models.CharField(max_length=200,blank=True, null=True, default="0")
    ...
    api_secret_updated_at = models.DateTimeField( null=True)
    api_key_updated_at = models.DateTimeField( null=True)
